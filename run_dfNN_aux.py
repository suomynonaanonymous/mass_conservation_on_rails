...
for run in range(NUM_RUNS):
    ...
    # NOTE: Specify number of total inputs (2 coords + 1 aux surface var)
    model = dfNN_aux(input_dim = 3).to(device)
    ...
    # NOTE: Specify number of total inputs (2 coords + 1 aux surface var)
    trained_model = dfNN_aux(input_dim = 3).to(device)
